...
namespace SS.Form.Core.Repositories
{
    public class FormRepository
    {
        ...
        {
            public const string Id = nameof(FormInfo.Id);

            public const string SiteId = nameof(FormInfo.SiteId);

            public const string Taxis = nameof(FormInfo.Taxis);
        }
        ...
        {
            var taxis = _repository.Get<int>(Q.Where(Attr.Id, formId));
