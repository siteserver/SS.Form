    ...
    public class AttributesImpl : IAttributes
    {
        ...
        public void Load(IDataReader reader)
        {
            ...
            for (var i = 0; i < reader.FieldCount; i++)
            {
                ...
                if (value is string && Context.DatabaseType == DatabaseType.Oracle && (string)value == OracleEmptyValue)
                {
                    value = string.Empty;
                }
                Set(name, value);
        ...
        public void Load(string json)
        {
            ...
            {
                var dict = FormUtils.JsonDeserialize<Dictionary<string, object>>(json);
                foreach (var key in dict.Keys)
                {
        ...
        public bool GetBool(string key, bool defaultValue = false)
        {
            ...
            return FormUtils.ToBool(value.ToString(), defaultValue);
        }
        ...
        public void Set(string name, object value)
        {
            ...
            {
                if (FormUtils.EqualsIgnoreCase(name, AttributeValues))
                {
                    Load(value.ToString());
                }
                else
        ...
        {
            return FormUtils.JsonSerialize(_dataDict);
        }
        ...
        public string ToString(List<string> excludeKeys)
        {
            ...
            {
                if (!FormUtils.ContainsIgnoreCase(excludeKeys, key))
                {
                    dict[key] = _dataDict[key];
                }
            }
            return FormUtils.JsonSerialize(dict);
        }
